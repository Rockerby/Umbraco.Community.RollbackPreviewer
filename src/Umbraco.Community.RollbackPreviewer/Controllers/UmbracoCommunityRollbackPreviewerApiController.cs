...
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "Umbraco.Community.RollbackPreviewer")]
    public class UmbracoCommunityRollbackPreviewerApiController : UmbracoCommunityRollbackPreviewerApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public UmbracoCommunityRollbackPreviewerApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
